	...
	<Gesture_set gesture_set_name="n-manipulate" >
			...
			<Gesture id="n-drag" type="drag">
				...
				<mapping>
					<update>
						<gesture_event>
							<property ref="drag_dx" target="x" delta_threshold="true" delta_min="0.01" delta_max="100" boundaryOn="true" boundary_min="100" boundary_max="1820"/>
							<property ref="drag_dy" target="y" delta_threshold="true" delta_min="0.01" delta_max="100" boundaryOn="true" boundary_min="100" boundary_max="980"/>
						</gesture_event>
					</update>
				</mapping>
			</Gesture>
			
			<Gesture id="n-drag2" type="drag">
				<comment>The 'n-drag' gesture can be activated by any number of touch points. When a touch down is recognized on a touch object the position
				of the touch point is tracked. This change in the position of the touch point is mapped directly to the position of the touch object.</comment>
				<match>
					<action>
				...
				<mapping>
					<update>
						<gesture_event>
							<property ref="drag_dx" target="x" delta_threshold="true" delta_min="0.01" delta_max="100" boundaryOn="false" boundary_min="100" boundary_max="1820"/>
							<property ref="drag_dy" target="y" delta_threshold="true" delta_min="0.01" delta_max="100" boundaryOn="false" boundary_min="100" boundary_max="980"/>
						</gesture_event>
					</update>
				</mapping>
			</Gesture>
			...
			<Gesture id="n-scale" type="scale">
				...
				<mapping>
					<update>
						<gesture_event>
							<property ref="scale_dsx" target="scaleX" func="linear" factor="0.0033" delta_threshold="true" delta_min="0.0001" delta_max="1" boundaryOn="true" boundary_min="0.5" boundary_max=".8"/>
							<property ref="scale_dsy" target="scaleY" func="linear" factor="0.0033" delta_threshold="true" delta_min="0.0001" delta_max="1" boundaryOn="true" boundary_min="0.5" boundary_max=".8"/>
						</gesture_event>
					</update>
				</mapping>
			</Gesture>
			
			<Gesture id="n-scale2" type="scale">
				<match>
					<action>
						<initial>
							<cluster point_number="0" point_number_min="2" point_number_max="5" separation_threshold="0"/>
				...
				<mapping>
					<update>
						<gesture_event>
							<property ref="scale_dsx" target="scaleX" func="linear" factor="0.0033" delta_threshold="true" delta_min="0.0001" delta_max="1" boundaryOn="false" boundary_min="0.5" boundary_max=".8"/>
							<property ref="scale_dsy" target="scaleY" func="linear" factor="0.0033" delta_threshold="true" delta_min="0.0001" delta_max="1" boundaryOn="false" boundary_min="0.5" boundary_max=".8"/>
						</gesture_event>
					</update>
				</mapping>
			</Gesture>
			...
			<Gesture id="1-finger-pivot" type="pivot">
				...
				<mapping>
					<update>
						<gesture_event>
							<property ref="pivot_dtheta" target="rotate" func="linear" factor="0.000002" delta_threshold="false" delta_min="0.0001" delta_max="1" boundaryOn="true" boundary_min="0" boundary_max="360"/>
						</gesture_event>
					</update>
				</mapping>
			</Gesture>
